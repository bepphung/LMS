...
const CourseDetails = () => {
  ...
  const { allCourses, calculateRating, calculateCourseDuration, calculateNoOfLuctures, calculateChapterTime, currency } = useContext(AppContext)
        ...
        <div className='p-5'>
          ...
          <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
            ...
            <div className='flex items-center gap-1'>
              ...
              <p>{calculateNoOfLuctures(courseData)} lessons</p>
            </div>
            
          </div>

          <button className='md:mt-5 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
