  ...
  return (
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='flex items-center justify-between w-full max-w-md mb-4'>
        <h1 className='text-2xl font-semibold'>Chỉnh sửa khóa học</h1>
        <button 
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-2'>
            <input 
              ...
              className='w-4 h-4'
            />
            <label htmlFor="isPublished">Xuất bản khóa học</label>
          </div>
        </div>

        {/* Chapters & Lectures */}
        <div>
          <p className='font-medium mb-2'>Nội dung khóa học</p>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lecture.lectureId} className='flex justify-between items-center mb-2 p-2 bg-gray-50 rounded'>
